...
const Skills = () => {
  ...
  return (
    <div className="inset-0 -z-10 h-full w-full items-center py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)]">
      ...
      >
        <motion.div
          className="text-4xl font-bold text-center mt-20 md:mt-12 md:text-5xl lg:text-6xl text-[#00df9a]"
          variants={containerVariants}
        >
          Skills and Stats
        </motion.div>
        <div className="w-full flex flex-wrap mt-10 gap-4 justify-center">
          {skills.map((skillCategory) => (
            <motion.div
              ...
              className="w-full max-w-md bg-black border border-[#00df9a] shadow-md rounded-lg p-6 mx-2"
              whileHover="hover"
        ...
        <div className="w-full flex flex-col md:flex-row lg:flex-row mb-4 justify-center items-center gap-4 mt-10">
          <motion.a
